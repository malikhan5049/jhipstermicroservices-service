...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "seahorsegateway@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "seahorsegateway API";

        private String description = "seahorsegateway API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "seahorsegateway";
